...
export function BalanceOverview() {
  ...
  const balanceData: BalanceOverviewPayload = balance?.data || {
    totalOwed: 0,
    totalOwes: 0,
    netBalance: 0,
    groupBalances: [],
    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Your balance breakdown across all groups</CardDescription>
        </CardHeader>
        <CardContent>
          {balanceData.groupBalances.length === 0 ? (
            ...
            <div className="space-y-4">
              {balanceData.groupBalances.map((group) => (
                <div key={group.groupId} className="flex items-center justify-between p-4 rounded-lg border">
                  ...
                  <div className="text-right">
                    ...
                    >
                      {group.netBalance > 0 ? "+" : ""}
                      {formatCurrency(group.netBalance, userCurrency)}
                    </div>
